...
//---
const arrMenuDownloader = ['instagram', 'ig', 'tiktok', 'tt', 'play', 'ytmp3', 'ytmp4'];
const arrMenuAI = ['ai', 'anidif'];
const arrMenuAnime = ['ongoing', 'jadwal'];
const arrMenuTools = ['hd', 'remini', 'upscale', 'kl', 'kalkulator', 'upload'];
const arrMenuFun = ['top', 'point', 'nyerah', 'hint', 'tebakkata', 'susunkata', 'slot', 'siapaaku', 'math', 'caklontong', 'asahotak'];
const arrMenuMaker = [];
const arrMenuOther = ['owner', 'gcbot'];
